...
```
$ cd src/
$ python can.py -i in/experiments/can_pc_S0.json
```
...
program as above and the latest checkpoint will be automatically picked.
...
provide you a link, for example: `http://warmachine:6006/` to access to the 
typical UI. Here you will be able to monitor training parameters, loss 
